...
func NewLoggerConfig(err bool) *Config {
	if err {
		return &Config{
...
func (loggerConfig *Config) GetLogger() (*log.Logger, error) {
...
func NewLogger(infoLoggerConfig *Config, errorLoggerConfig *Config) (*Logger, error) {
